  ...
  template: `
    @if (dialogService.dialog().isOpen) {
      <div class="fixed inset-0 z-[9999] flex items-center justify-center">
        ...
        <!-- Dialog Card -->
        <div
          class="relative bg-slate-900/95 border border-white/20 rounded-lg shadow-[0_0_40px_rgba(139,92,246,0.3)] max-w-md w-full mx-4 overflow-hidden"
        >
            ...
            <div
              ...
              [ngClass]="{
                'bg-gradient-to-r from-cyan-600/20 to-blue-600/20':
                  dialogService.dialog().type === 'info',
                'bg-gradient-to-r from-purple-600/20 to-fuchsia-600/20':
                  dialogService.dialog().type === 'confirm',
                'bg-gradient-to-r from-red-600/20 to-orange-600/20':
                  dialogService.dialog().type === 'error',
                'bg-gradient-to-r from-yellow-600/20 to-amber-600/20':
                  dialogService.dialog().type === 'warning',
              }"
            >
