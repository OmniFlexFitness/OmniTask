    ...
    <aside class="ofx-sidebar h-full flex flex-col">
      ...
      <div class="px-4 py-5 border-b border-white/10">
        <div class="flex items-center justify-between">
          ...
          <button class="ofx-icon-button" (click)="showCreateForm.set(true)" title="Create Project">
            <svg
      ...
      <div class="px-4 py-4 border-b border-white/10 bg-slate-900/50">
        <div class="space-y-3">
          ...
          <div class="flex gap-2">
            ...
            <button class="ofx-ghost-button text-xs px-3 py-2" (click)="showCreateForm.set(false)">
              Cancel
            </button>
          </div>
        </div>
      ...
      <nav class="flex-1 overflow-y-auto py-2">
        ...
        <div class="px-4 py-8 text-center text-slate-400 text-sm">
          <div
            class="ofx-empty-icon mx-auto mb-3 w-12 h-12 rounded-full bg-slate-800/50 flex items-center justify-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        >
          ...
          <span class="ofx-chip text-xs bg-gray-700/50 text-gray-400"> Archived </span>
          }
        </button>
        } }
      </nav>
      ...
      <div class="px-4 py-3 border-t border-white/10 text-xs text-slate-500 space-y-2">
        <div class="flex items-center justify-between">
          ...
          >
            @if (seeding()) { Loading... } @else { + Sample Data }
          </button>
        </div>
      </div>
    </aside>
